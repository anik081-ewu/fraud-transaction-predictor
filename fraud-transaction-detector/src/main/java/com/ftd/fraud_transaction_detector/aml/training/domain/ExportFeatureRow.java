...
public record ExportFeatureRow(
        ...
        long terminalTransactionCount1Day,
        long terminalFraudCount1Day,
        double terminalFraudRate1Day,
        double terminalAverageAmount1Day,
        long terminalTransactionCount7Days,
        long terminalFraudCount7Days,
        double terminalFraudRate7Days,
        double terminalAverageAmount7Days,
        long terminalTransactionCount30Days,
        long terminalFraudCount30Days,
        double terminalFraudRate30Days,
        double terminalAverageAmount30Days,
        boolean terminalRiskAvailable,
        Boolean fraudLabel,
        String labelSource
) {
}
