# OpenML dataset: CreditCardFraudDetection

https://www.openml.org/d/42397
...
This is a [read-only mirror](https://gitlab.com/data/d/openml/42397) of an [OpenML dataset](https://www.openml.org/d/42397). Contribute any changes to the dataset there. Alternatively, [fork the dataset](https://gitlab.com/data/d/openml/42397/-/forks/new) or [find an existing fork](https://gitlab.com/data/d/openml/42397/-/forks) to contribute to.

You can use [issues](https://gitlab.com/data/d/openml/42397/-/issues) to discuss the dataset and any issues.
